...
assert.match(html, /data\/vehicle-historical-applications\.js/);
assert.match(html, /data\/vehicle-catalog\.js/);
assert.match(html, /function vehicleApplicationRows\(selection=\{\}\)/);
assert.match(html, /VEHICLE_APPLICATION_DATA\.records\(selection\)/);
assert.match(html, /VEHICLE_APPLICATION_DATA\.values\(field,selection\)/);
assert.match(html, /VEHICLE_APPLICATION_DATA\.options\(field,selection\)/);
